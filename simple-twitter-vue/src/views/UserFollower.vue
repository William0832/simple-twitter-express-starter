<template>
  <div class="container-fluid">
    <div class='row px-5 mx-auto' style="width: 85%;">
      <UserProfileCard :initial-profile="profile" :initial-isFollowed="isFollowed" class="col-md-4 mr-auto" />
      <UserFollowerCard :initial-profile="profile" class="col-md-8"/>
    </div>
  </div>
</template>
    ...
    Followers: [
      {
        ...
        description: "ohuispppppppppppppppppppppppppp",
    ...
    Followings: [
      {
        ...
        isAdmin: false,
        image: "https://i.imgur.com/Q14p2le.jpg",
        description: "opdfksoooooooooooooooooooooooooooooooiiiiiiii",
        createdAt: "2019-07-30T16:24:55.204Z",
        updatedAt: "2019-08-01T10:34:15.105Z",
        Followship: {
          followerId: 1,
      ...
      },
      {
        ...
        description: "opdfks909909999999999999999999999999999999999999999999",
